    ...
    <Layout>
      <div className="min-h-[90vh] pt-5 flex flex-col flex-wrap gap-10 text-white">
        ...
        <div className="grid grid-cols-2 gap-5 m-auto mx-10 ">
          ...
          <div className="flex flex-col items-center gap-10 p-5  shadow-[0px_-3px_50px_-5px] shadow-blue-500 rounded-md">
            ...
            <div className="grid grid-cols-2 gap-5">
              ...
              <div className="flex items-center justify-between py-5 px-5 gap-5 rounded-md border border-blue-300">
          ...
          <div className="flex flex-col items-center gap-10 p-5  shadow-[10px_-5px_50px_-5px] shadow-blue-500 rounded-md">
              ...
              {myCourses?.map((element, index) => {
                return (
                  <tr key={element?._id}>
                    ...
                    <td className="flex items-center gap-4 h-[90px]">
                      {/* to edit the course */}
                      <button
                        onClick={() =>
                          navigate("/course/create", {
