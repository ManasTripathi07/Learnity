    ...
    <Layout>
      <div className="flex flex-col gap-10 items-center justify-center min-h-[90vh] py-10 text-white mx-[5%]">
        ...
        <div className="flex justify-center gap-10 w-full">
          ...
          <div className="space-y-5 w-[28rem] p-2 rounded-lg shadow-[10px_-5px_50px_-5px] shadow-blue-500">
            <video
          ...
          <ul className="w-[28rem] p-6 rounded-lg shadow-[10px_-5px_50px_-5px] shadow-blue-500 space-y-4">
