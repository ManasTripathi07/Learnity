    ...
    <Layout>
      ...
      <div className="flex items-center justify-center h-[100vh]">
        ...
        <form
          ...
          className="flex flex-col justify-center gap-6 rounded-lg p-4 text-white w-80 h-[26rem] mx-3 my-7 shadow-[10px_-5px_50px_-5px] shadow-blue-500"
        >
          <h1 className="text-center text-2xl font-bold">Change Password</h1>

          <div className="flex flex-col gap-1">
            <label className="text-lg font-semibold label-style" htmlFor="oldPassword">
              Old Password
            </label>
            <input
              required
          ...
          <div className="flex flex-col gap-1">
            <label className="text-lg font-semibold label-style" htmlFor="newPassword">
              New Password
            </label>
            <input
              required
