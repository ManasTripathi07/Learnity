    ...
    <Layout>
      <div className="flex items-center justify-center h-[100vh]">
        <form
          ...
          className="flex flex-col  justify-center gap-5 rounded-lg p-4 text-white w-80 h-[26rem] mx-3 my-7 shadow-[10px_-5px_50px_-5px] shadow-blue-500"
        >
          ...
          <div className="flex flex-col gap-1">
            <label className="text-lg font-semibold label-style " htmlFor="fullName">
              Full Name
            </label>
            <input
              required
